...
public class OffMeshLinkJump : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        while (true)
        {
            //IsOnJump() 함수의 반환 값이 true일 때까지 반복 호출
    ...
    public bool IsOnJump()
    {
        if (navMeshAgent.isOnOffMeshLink)
        {
            ...
            // 현재 위치에 있는 OffMeshLnk의 OffMeshLinkType이 JumpAcross이면
